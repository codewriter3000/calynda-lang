...
int main(void) {
    ...
    RUN_TEST(test_mir_dump_preserves_static_extent_for_explicit_unsized_array_binding);
    RUN_TEST(test_mir_dump_preserves_static_extent_across_declared_array_return_boundary);
    RUN_TEST(test_mir_dump_lowers_callable_local_bindings_and_nested_closures);
    RUN_TEST(test_mir_dump_prunes_unreachable_top_level_callable_units);
    RUN_TEST(test_mir_dump_prunes_unreachable_pure_module_init_bindings);
    RUN_TEST(test_mir_dump_prunes_unreachable_branching_module_init_binding);
    RUN_TEST(test_mir_dump_prunes_unreachable_short_circuit_module_init_bindings);
    RUN_TEST(test_mir_dump_keeps_call_backed_module_init_bindings);
    ...
    RUN_TEST(test_mir_dump_mmio_type_uses_typed_memory_helpers);
    RUN_TEST(test_mir_dump_mmio_value_member_uses_typed_rmw_helpers);
    RUN_TEST(test_mir_dump_fence_builtin_lowers_to_runtime_helper);
    RUN_TEST(test_mir_dump_cache_builtins_lower_to_runtime_helpers);
