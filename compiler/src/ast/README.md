...
- Array type nodes keep declared fixed extents long enough for downstream semantic validation.
- Named-type coverage now includes the `mmio<T>` surface used by the low-level runtime helpers.
