...
int main(void) {
    ...
    RUN_TEST(test_hir_dump_synthesizes_default_initializers_for_omitted_bindings);
    ...
    RUN_TEST(test_hir_dump_lowers_monolithic_scene60_hetero_array);
