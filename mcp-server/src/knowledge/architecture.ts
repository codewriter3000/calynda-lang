...
const PIPELINE_STAGES_BACKEND = [
  ...
  },
  {
    ...
    description:
      'Target-aware code generation via TargetDescriptor abstraction (x86_64 SysV ELF, AArch64 AAPCS64 ELF, and RISC-V 64 LP64D ELF). Classifies LIR ops into direct machine-pattern candidates vs runtime helpers. Uses target-specific register sets for allocation.',
    keyTypes: [
  ...
  },
  {
    ...
    description:
      'Target-agnostic machine layer consuming LIR + codegen plan. Emits instruction streams, helper-call setup, prologue/epilogue, and conservative register preservation. All operations use TargetDescriptor for register names and ABI conventions. Supports x86_64, AArch64, and RISC-V 64.',
  ...
  },
  {
    ...
    dir: 'compiler/src/backend/',
    description:
      'Lowers MachineProgram into GNU assembler text with concrete stack addresses, rodata literals, global storage, string-object data, runtime helper calls, main entry glue, and .note.GNU-stack. Dispatches to x86_64, AArch64, or RISC-V emitters based on target.',
    keyTypes: [],
