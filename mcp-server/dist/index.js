...
const server = new index_js_1.Server({ name: 'calynda-mcp-server', version: '0.5.0' }, { capabilities: { tools: {}, resources: {}, prompts: {} } });
...
server.setRequestHandler(types_js_1.ListResourcesRequestSchema, async () => ({
    resources: [
        { uri: 'calynda://grammar', name: 'Calynda Grammar (EBNF)', description: 'The full V2 EBNF grammar snapshot (0.5.0)', mimeType: 'text/plain' },
