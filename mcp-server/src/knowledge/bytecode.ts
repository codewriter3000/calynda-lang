...
export const BYTECODE_TARGET = 'portable-v1';

export const BYTECODE_ISA = `# Bytecode ISA — portable-v1
...
export const BYTECODE_INSTRUCTIONS = [
...
export const BYTECODE_TERMINATORS = [
